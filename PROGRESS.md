...
2. ~~**多语言版本（i18n 骨架：zh-CN + en）**~~ ✅ **已完成**（2025-07-11）
   ...
   - 已翻译核心用户旅程：外壳、落地页、登录/注册、平台大厅、我的、数据看板（公开部分）、入驻/NDA/结算/排行榜 标题
   - 渐进式方案：中文为源、英文为资源，未译 key 自动以中文兜底，不漏译不报错
   - 已 build（通过）+ 提交 + 推送，缓存版本 `rzq-v14`
   - 待补：其余页面正文（聊天/购物车/结算/文件/圈子/资料/市场/技能包/游戏等）按需逐页翻译
